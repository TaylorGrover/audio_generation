...
$$
A_i=\frac{2}{\lambda}\int_0^\lambda s(t)\sin\left(\frac{2\pi it}{\lambda}\right)\mathop{dt}
$$
...
## Signal Chain
Just a sequence of functions that transform an input signal into a final processed
output.
